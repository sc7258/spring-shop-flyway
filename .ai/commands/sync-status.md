...
- `32-todo.md`에는 현재 활성 Phase의 미완료 항목만 남깁니다.
- 다음 Phase 이상의 작업은 `32-todo.md`로 이동하지 않고 `30-roadmap.md`에만 유지합니다.
- 현재 Phase 완료 시, `32-todo.md`는 다음 Phase 기준으로 교체하되 한 번에 하나의 Phase만 노출합니다.
